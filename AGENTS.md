# AGENTS.md — Strudel jam

> OpenCode counterpart of `CLAUDE.md` — auto-discovered by OpenCode and appended to the
> system prompt. Kept in sync by hand; if you edit jam rules, edit both files.
...
- **CLAUDE.md** is the Claude Code copy of this file; keep the two in sync if you edit rules.
